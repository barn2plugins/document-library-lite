	...
	public function __construct() {
		...
		$this->set_description(
			sprintf(
				...
				Util::generate_utm_url( 'https://barn2.com/wordpress-plugins/bundles/', 'dlw', $this->get_plugin() ),
				Util::generate_utm_url( 'https://barn2.com/kb/how-to-upgrade-license/', 'dlw', $this->get_plugin() )
			)
		);
