...
class ComposerAutoloaderInit8f46b741b3fc545944ffe0b77210fba6
{
    ...
    public static function getLoader()
    {
        ...
        self::$loader = $loader = new \Barn2\Plugin\Document_Library\Dependencies\Composer\Autoload\ClassLoader(\dirname(\dirname(__FILE__)));
        \spl_autoload_unregister(array('ComposerAutoloaderInit8f46b741b3fc545944ffe0b77210fba6', 'loadClassLoader'));
        $useStaticLoader = \PHP_VERSION_ID >= 50600 && !\defined('Barn2\\Plugin\\Document_Library\\Dependencies\\HHVM_VERSION') && (!\function_exists('zend_loader_file_encoded') || !\zend_loader_file_encoded());
        if ($useStaticLoader) {
