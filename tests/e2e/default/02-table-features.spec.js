...
test.describe('initial loading', (props) => {
	test( 'table columns work fine', async ({
        ...
        await admin.visitAdminPage( 'admin.php?page=document_library&tab=document_libraries' );
        ...
        await admin.visitAdminPage( 'admin.php?page=document_library&tab=document_libraries' );
        await page.getByLabel( 'Columns' ).fill( 'id, title, content, image, date, doc_categories, link' );
        await page.getByRole( 'button', {name: 'Save Changes'} ).click();
        await page.waitForLoadState( 'domcontentloaded' );
    ...
    test( 'download button works fine', async ({
        ...
        await page.goto( '/document-library' );
        await expect(page.locator( '.document-library-table tbody tr:nth-child(1) td:last-child a' ) ).toHaveText( 'Get file' );
        ...
        await page.goto( '/document-library' );
        await expect(page.locator( '.document-library-table tbody tr:nth-child(1) td:last-child a' ) ).toHaveText( 'Download' );
        await expect(page.locator( '.document-library-table tbody tr:nth-child(1) td:last-child a .dll-icon' ) ).toBeVisible();
        ...
        await page.goto( '/document-library' );
        await expect(page.locator( '.document-library-table tbody tr:nth-child(1) td:last-child a' ) ).toHaveText( '' );
        await expect(page.locator( '.document-library-table tbody tr:nth-child(1) td:last-child a .dll-icon' ) ).toBeVisible();
        ...
        await page.goto( '/document-library' );
        await expect(page.locator( '.document-library-table tbody tr:nth-child(1) td:last-child a.dll-download-button' ) ).not.toBeVisible();
        await expect(page.locator( '.document-library-table tbody tr:nth-child(1) td:last-child a' ) ).toBeVisible();
        ...
        await page.goto( '/document-library' );
        await expect(page.locator( '.document-library-table tbody tr:nth-child(1) td:last-child a .dll-icon.pdf' ) ).toBeVisible();
    ...
    test( 'showing images in a lightbox work fine', async ({
        ...
        await page.goto( '/document-library' );
        await page.locator( '.document-library-table tbody tr:nth-child(1) td:nth-child(4) img' ).click();
